...
thirdparty=`egrep -vi "AMBARI_INFRA|AMBARI_METRICS|ATLAS|FLUME|HBASE|HDFS|HIVE|KAFKA|MAPREDUCE2|PIG|RANGER|RANGER_KMS|SLIDER|SMARTSENSE|SPARK|SPARK2|SQOOP|TEZ|YARN|ZOOKEEPER|NIFI|KERBEROS|KNOX" $INTR/files/services.txt | grep -v -i spark2 | tr -s '\n ' ','`
